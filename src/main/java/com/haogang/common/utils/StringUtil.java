...
public class StringUtil {
	...
	//方法3-1：返回1个中文字符串，字符集必须在GB2312（中文简体）范围内
	...
	//方法3-2：返回参数length个中文字符串，字符集必须在GB2312（中文简体）范围内
	...
	//方法4：返回中文姓名，必须以真实姓开头，百家姓在“六、附百家姓”里，名使用1-2个随即汉字，内部调用randomChineseString（）方法
